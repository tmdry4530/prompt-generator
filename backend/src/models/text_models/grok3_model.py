"""
Grok 3 모델 최적화 모듈: Grok 3 모델에 최적화된 프롬프트를 생성합니다.
"""
...
class Grok3Model(BaseModel):
    """
    Grok 3 모델에 최적화된 프롬프트를 생성하는 클래스
    """
    ...
    def get_prompt_structure(self) -> Dict[str, Any]:
        """
        Grok 3 모델에 최적화된 프롬프트 구조를 반환합니다.
    ...
    def optimize_prompt(self, analysis_result: Dict[str, Any], intent_result: Dict[str, Any]) -> str:
        """
        분석 결과와 의도 결과를 기반으로 Grok 3에 최적화된 프롬프트를 생성합니다.
    ...
    def _generate_role(self, analysis_result: Dict[str, Any], intent_result: Dict[str, Any]) -> str:
        ...
        elif intent_result.get("is_conversational", False):
            role = self.role_templates["conversational"]
    ...
    def apply_common_rules(self, prompt: str) -> str:
        """
        Grok 3에 최적화된 공통 규칙을 프롬프트에 적용합니다.
    ...
    def get_capability_specific_tips(self, capability: str) -> List[str]:
        ...
        tips = {
            "text_generation": [
                ...
                "직접적인 질문 형식을 사용하면 더 정확한 응답을 얻을 수 있습니다.",
